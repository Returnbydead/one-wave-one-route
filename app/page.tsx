      ...
      <section className="workspace">
        ...
        <section className="monitor-section panel" id="picking-monitor">
          <div className="monitor-head">
            <div className="panel-head"><div><span>04</span><div><h3>Live picking monitor</h3><p>Aktivitas aktual WMS untuk SO One Wave One Route · refresh setiap 5 menit</p></div></div></div>
